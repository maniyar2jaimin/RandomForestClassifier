...
public class TreeNode extends Node {
	 ...
	 * @param level
	 */
	public TreeNode(List<Record> dataSet, int labelIndex, List<Attribute> attributes, int level) {
	...
	public void split() {
		this.updateEntropy();
		if (super.getEntropy() > this.threshhold && this.getAllSamples().size() > 1) {
			// going to split
...
//			System.out.println(nextsplitAttrIndex);
		} else {
